...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'station_id',array('size'=>3,'maxlength'=>3)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'land_line',array('size'=>10,'maxlength'=>10)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'mobile_number'); ?>
		<?php echo $form->textField($model,'mobile_number',array('size'=>11,'maxlength'=>11)); ?>
	</div>
