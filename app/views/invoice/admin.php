...
<div class="top-mini-icons-div-container">
    <div class="top-mini-icons-div"><?php echo CHtml::link('<span class="hspan">Add&nbsp;Invoice</span>', array('//invoice/create'), array('class'=>'mini-icons-add icon32')); ?></div>
...
<div class="well gridview">
    <?php $this->widget('yiiwheels.widgets.grid.WhGridView', array(
        ...
        'columns'=>array(
            'id',
            'vehicle_no',
            array('name'=>'stock_type', 'value'=>'$data->stockText'),
            array('name'=>'quantity', 'value'=>'Yii::app()->numberFormatter->format("#,##0L",$data->quantity)'),
            array('name'=>'amount', 'value'=>'Yii::app()->numberFormatter->format("₦#,##0.00",$data->amount)'),
            array('name'=>'price', 'value'=>'Yii::app()->numberFormatter->format("₦#,##0.00",$data->price)'),
            array('name'=>'invoice_type','value'=>'$data->typeText'),
            array('header'=>'Actual Quantity', 'name'=>'adjustment'),
            'invoice_date',
            'date_received',
            array(
