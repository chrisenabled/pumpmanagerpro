...
class mPrint extends CWidget {
	...
	*/
    ...
    public function run() {
        ...
        if($this->printText == '')$this->printText = 'Print&nbsp;Grid';
    ...
    private function showPrintLink() {
        ...
        echo CHtml::link('<span class="hspan">'.$this->printText.'</span>', "", array_merge($this->htmlOptions,
            array('id' => $this->id, 'class'=>'mini-icons-print icon32', 'title'=>$this->tooltip, 'alt'=>$this->alt)));
    }
